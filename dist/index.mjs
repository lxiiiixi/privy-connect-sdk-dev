...
function WalletConnectButton({
  ...
  if (!boomWallet || !(boomWallet == null ? void 0 : boomWallet.isConnected))
    return /* @__PURE__ */ jsxs3("div", { className: "boom_privy_button_container", children: [
      /* @__PURE__ */ jsx5(
        ConnectWalletModal,
        {
          isOpen,
  ...
  return /* @__PURE__ */ jsx5("div", { className: "boom_privy_button_container", children: /* @__PURE__ */ jsx5(
    Selector_default,
    {
      ...
      children: /* @__PURE__ */ jsxs3(Fragment2, { children: [
        /* @__PURE__ */ jsx5("div", { className: `dropdown-item`, onClick: boomWallet.disconnect, children: /* @__PURE__ */ jsx5("span", { children: "Logout" }) }),
        boomWallet.type === "EMAIL" && /* @__PURE__ */ jsx5("div", { className: `dropdown-item`, onClick: boomWallet.exportWallet, children: /* @__PURE__ */ jsx5("span", { children: "Export Wallet" }) }),
        boomWallet.type === "EMAIL" && option && /* @__PURE__ */ jsx5(
          "div",
          {
...
function ExternalWalletList() {
  ...
  return /* @__PURE__ */ jsxs3("div", { className: "privy_wallet_list_container", children: [
    visibleWallets.map((wallet) => /* @__PURE__ */ jsxs3(
      "button",
      {
        onClick: () => {
        ...
        children: [
          /* @__PURE__ */ jsx5("img", { src: wallet.adapter.icon, alt: wallet.adapter.name, width: 24 }),
          /* @__PURE__ */ jsxs3("div", { className: "privy_wallet_list_item_name", children: [
            " ",
            wallet.adapter.name,
            " "
          ] })
...
function PrivyLogin({ onClose }) {
  ...
  return /* @__PURE__ */ jsxs3("div", { className: "privy_login_container", children: [
    /* @__PURE__ */ jsxs3("div", { className: "privy_login_title", children: [
      "Protected by ",
      /* @__PURE__ */ jsx5("img", { src: src_privy_dark, alt: "privy", width: 56 })
    ] }),
    /* @__PURE__ */ jsxs3("div", { className: "privy_email_form", children: [
      /* @__PURE__ */ jsx5("img", { src: src_email, alt: "email", width: 20 }),
      /* @__PURE__ */ jsx5(
        "input",
        {
          type: "email",
    ...
    /* @__PURE__ */ jsxs3("div", { className: "privy_login_mpc_tip", children: [
      "MPC wallet is more ",
      /* @__PURE__ */ jsx5("img", { src: src_secure, alt: "secure", width: 80 })
    ] }),
    /* @__PURE__ */ jsx5(
      "button",
      {
...
function ConnectWalletModal({
  ...
  return /* @__PURE__ */ jsxs3(Modal_default, { isOpen, onClose, children: [
    /* @__PURE__ */ jsx5("h4", { className: "modal_title", children: "Log in or Sign up" }),
    /* @__PURE__ */ jsx5(PrivyLogin, { onClose }),
    !hideConnectByWallets && /* @__PURE__ */ jsx5(Divider_default, {}),
    !hideConnectByWallets && /* @__PURE__ */ jsx5(ExternalWalletList, {})
  ] });
}
